...
import { Table, Tooltip, Form, Col, Input, Button } from 'antd';
			...
			<div className="common">
				<div className="common_search">
					<Form className="common_search_form" {...formItemLayout}>
						<Col span={6}>
							<FormItem label="厨房名称">
								{getFieldDecorator('name')(<Input placeholder="请输入厨房名称" />)}
							</FormItem>
						</Col>
						<Col span={6} offset={1}>
							<Button type="primary" onClick={this.onSearchEvaluateList.bind(this)}>
								查询
							</Button>
						</Col>
					</Form>
